  ...
  return (
    <div className="min-h-screen bg-[#070d0f] text-slate-100 flex flex-col font-sans selection:bg-[#00A767] selection:text-white">
      ...
      <Header
        isAdmin={isAdmin}
        onLoginClick={() => {
          // Smooth scroll to administrator dashboard
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 md:px-6 py-6 space-y-6">
              ...
              <div className="h-[400px] bg-slate-950/40 rounded-xl border border-dashed border-slate-800 flex flex-col items-center justify-center text-center p-6 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 max-w-md">
                    O banco de dados se encontra vazio ou desconectado. Efetue login como Administrador abaixo para adicionar ou escanear via ONVIF IPs internos.
                  </p>
                </div>
              </div>
            ) : viewMode === "grid" ? (
        ...
        {/* 3. ADMINISTRATION AND SYNC MANAGER CONTAINER */}
        <div id="admin-container" className="pt-6 border-t border-slate-800/50">
          <AdminPanel
            isAdmin={isAdmin}
